...
export class CuentasController {
  ...
  getResumen(@Headers('x-empresa-id') empresaId: string) {
    return this.cuentas.getResumen(empresaId);
  }
  ...
  registrarAbono(
    ...
    return this.cuentas.registrarAbono(clienteId, dto, empresaId, user.sub);
  }
  ...
  registrarAjuste(
    ...
    return this.cuentas.registrarAjuste(clienteId, dto, empresaId, user.sub);
  }
}
