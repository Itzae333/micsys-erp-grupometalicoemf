...
export class ClientesController {
  ...
  findAll(
    ...
    return this.clientes.findAll(ubicacionId, q);
  }

  @Get(':id')
  @ApiOperation({ summary: 'Detalle de cliente' })
  findOne(@Headers('x-ubicacion-id') ubicacionId: string, @Param('id') id: string) {
    return this.clientes.findOne(id, ubicacionId);
  }

  @Post()
  @Roles('SUPER_USUARIO', 'ADMIN', 'ENCARGADO', 'VENDEDOR')
  @ApiOperation({ summary: 'Crear cliente' })
  create(@Headers('x-ubicacion-id') ubicacionId: string, @Body() dto: CreateClienteDto) {
    return this.clientes.create(dto, ubicacionId);
  }
  ...
  update(
    ...
    return this.clientes.update(id, dto, ubicacionId);
  }
  ...
  getCuenta(
    ...
    return this.clientes.getCuenta(id, ubicacionId, page, limit);
  }
  ...
  abonarCuenta(
    ...
    return this.clientes.abonarCuenta(id, ubicacionId, dto, user.sub);
  }

  @Delete(':id')
  @Roles('SUPER_USUARIO', 'ADMIN')
  @ApiOperation({ summary: 'Activar/desactivar cliente' })
  toggleActivo(@Headers('x-ubicacion-id') ubicacionId: string, @Param('id') id: string) {
    return this.clientes.toggleActivo(id, ubicacionId);
  }
}
